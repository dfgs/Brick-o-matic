...
namespace Brick_o_matic.Math.UnitTest
{
	...
	public class BoxUnitTest
	{
		...
		public void ShouldNotIntersectWithCoordinate()
		{
			...
			box1 = new Box(new Position(0, 0, 0), new Size(1, 1, 1));
			Assert.IsFalse(box1.IsInside(new Position(-1, 0, 0)));
			Assert.IsFalse(box1.IsInside(new Position(1, 0, 0)));
			Assert.IsFalse(box1.IsInside(new Position(0, -1, 0)));
			Assert.IsFalse(box1.IsInside(new Position(0, 1, 0)));
			Assert.IsFalse(box1.IsInside(new Position(0, 0, -1)));
			Assert.IsFalse(box1.IsInside(new Position(0, 0, 1)));
		}
		...
		public void ShouldIntersectWithCoordinate()
		{
			...
			box1 = new Box(new Position(0, 0, 0), new Size(5, 5, 5));
			Assert.IsTrue(box1.IsInside(new Position(0, 0, 0)));
			Assert.IsTrue(box1.IsInside(new Position(4, 4, 4)));
			Assert.IsTrue(box1.IsInside(new Position(1, 2, 3)));
			Assert.IsTrue(box1.IsInside(new Position(3, 2, 1)));
		}
